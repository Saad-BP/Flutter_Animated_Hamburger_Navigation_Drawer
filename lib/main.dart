...
class _MyHomePageState extends State<MyHomePage> {
  ...
  double bottomRotateValue = 0; //The rotate value of the bottom line (the angle)! 
  double middleLineMovement = 0; // To move the middle line when the animation is started!
